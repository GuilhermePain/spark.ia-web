...
export default function SignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://spark-ia.duckdns.org/api/autenticar', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className={`flex items-center justify-center h-[100vh] w-[100vw] bg-[#011F3B] transition-all duration-1000 ease-in-out
      ...
      <div className="bg-white p-8 rounded-lg shadow-md max-w-[85%] sm:w-[80%] md:h-[600px] flex flex-col items-center justify-center md:justify-around md:flex-row ">
