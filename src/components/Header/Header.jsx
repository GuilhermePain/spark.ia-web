      ...
      <nav className="flex justify-between items-center">
        ...
        {!hideLinks && (
          <>
            ...
            <ul
              className={`fixed top-0 left-0 right-0 bg-[#011F3B] text-white transition-transform duration-300 ease-in-out transform ${
            ...
            >
              ...
              <li
                className={`${
                  userExisting ? "flex" : "hidden"
                } md:hidden flex-col items-center gap-5 border-y-[1px] border-slate-700 p-2 w-full text-white text-center md:border-none md:w-auto`}
              >
                <div className="rounded-full bg-red-500 w-28 h-28">&nbsp;</div>
                <Button text="Sair" width={28} onClick={logout} />
              </li>
              <li
                className={`${
                  userExisting ? "hidden" : "block"
                } border-y-[1px] border-slate-700 p-2 w-full text-center md:border-none md:w-auto hover:text-[#fa7807] active:text-[#FDAD0B]`}
              >
                Início
              </li>
              <li
