...
export default function Card({ img, altText, title, text, typeCard, link }) {
  ...
  return (
    <div className="bg-white shadow-2xl rounded-[20px] flex flex-col items-center justify-center h-[450px] md:w-[600px] md:h-[500px] cursor-pointer">
        <div>
            <img src={img} alt={altText} className="h-[130px] md:h-[200px]"/>
        </div>
        <div className="w-full p-5 flex flex-col justify-center items-center gap-2">
            ...
            <p className="text-justify text-[#818181]">{text}</p>
        </div>
        {
